...
The `act` command which will be used will be the exact same as the first two cases (again assuming no <a href="/github-local-actions-docs/usage/settings">settings</a> are being used).
